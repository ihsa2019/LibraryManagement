...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f6f273cf-e479-42b9-a7ee-46861579f1b3
```

> `f6f273cf-e479-42b9-a7ee-46861579f1b3` is the password of the certificate, you can change it to any password you want.
