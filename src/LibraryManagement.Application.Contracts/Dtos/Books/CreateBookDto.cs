...
public class CreateBookDto
{
    ...
    [Required] [StringLength(50)] public string Publisher { get; set; }

    [Required] [DataType(DataType.Date)] public DateTime PublicationDate { get; set; }

    [Required] public int PageCount { get; set; }

    [Required] public BookGenre Genre { get; set; }

    [Required] public BookFormat Format { get; set; }

    [Required] public BookStatus Status { get; set; }

    [Required] [StringLength(20)] public string Language { get; set; }
    ...
    [Required] [DataType(DataType.Date)] public DateTime? LastBorrowedDate { get; set; }
}